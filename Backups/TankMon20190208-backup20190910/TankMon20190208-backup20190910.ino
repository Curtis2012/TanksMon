...
//int sonarPins[numTanks][2]= {{14,12} {13,15}};  // Ping/echo pin pairs. Ping pins in row 1. Echo pins row 2
...
/*      Serial.println();
      ...
      Serial.print(sonars[t].trigPin);
      Serial.flush();

      Serial.println();
      Serial.println("Echo pin");
      Serial.print(sonars[t].echoPin);
      Serial.flush();
